...
// echo $this->table_meta['frontend_sql_filter'];
			...
			if ($do_run_query and $this->get_table_records()) {
				if (!$this->record_id) $this->count_records();
	...
	function __construct($table, $site_id, $record_id, $master_table = NULL, $master_id = NULL, $page = 1, $conn = NULL, $lang_id = '') {
		parent::__construct($table, $site_id, $record_id, true, NULL, $master_table, $master_id, NULL, NULL, NULL, $conn, $lang_id);
