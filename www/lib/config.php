<?
$config['DEBUG_ENABLED'] = true; // error reporting

$config['DB_SERVER'] = 'localhost';
$config['DB_USER'] = 'root';
$config['DB_PASSWORD'] = '';
$config['DB_DATABASE'] = 'cms_v6';
...
$config['MAIL_FROM_NAME'] = 'Aspect Press';
$config['MAIL_FROM_EMAIL'] = 'no-replay@aspectpress.ru';
...
$config['MAIL_CONTENT_HTTP_HOST'] = 'http://aspectpress.ru';
