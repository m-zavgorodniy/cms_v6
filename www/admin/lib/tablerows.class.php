...
<?	}
	...
	function __construct($table, $site_id, $sql_filter = NULL, $master_table = NULL, $master_id = NULL, $many2many_table = NULL, $records_from = NULL, $conn = NULL) {
		parent::__construct($table, $site_id, NULL, true, $sql_filter, $master_table, $master_id, $many2many_table, $records_from, RECORDS_ON_PAGE_NUM, $conn);
	}
}
?>